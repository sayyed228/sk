 ...
 function slideout(){
  ...
  $("#response").slideUp("slow", function () {
	...
	$("#list ul").sortable({ opacity: 0.8, cursor: 'move', update: function() {
			...
			$.post("client-list-update-list.php", order, function(theResponse){
  ...
  <div id="list">
    ...
    <ul>
      <?php
				...
				?>
      <li id="arrayorder_<?php echo $id ?>"> <i class="fa fa-arrows pointer"></i>&nbsp; <span class="Banks_and_Financial_Institutions"><?php echo $text; ?></span>
...
$(document).ready(function (e) {
    ...
    function example() {
        ...
        aa.open("GET", "client-list-update.php?id=" + id + "&Banks_and_Financial_Institutions=" + Banks_and_Financial_Institutions, true)
        aa.send()
    }
    ...
    function Delete_Banksand_Financial_Institutions() {
        ...
        aa.open("GET", "client-list-delete.php?id=" + id, true)
        aa.send()
    ...
    function Add_Banks_and_Financial_Institutions() {
		...
		alert(listorder)
        aa.open("GET", "client-list-add.php?Add=" + Add + "&listorder=" + listorder, true)
        aa.send()
		 setTimeout(function(){
  	  location.reload();
	 }, 800);
